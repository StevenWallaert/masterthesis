...
```{r descriptives, warning=F, message=F, out.width="75%", fig.align='center', fig.cap="\\textit{Distributions of descriptive statistics of gene expression levels of both strains.}"}
...
```{r hist, out.width="75%", fig.align="center", fig.cap="\\textit{Histogram of the test statistics. The vertical dashes show the individual data points.}"}
...
```{r beforeafter, out.width="75%", fig.align='center', fig.cap="\\textit{Corrected vs. uncorrected test statistics plot. The dashed line shows y=x.}"}
# step 3: calculate l'()
l_prime <- function(x){
